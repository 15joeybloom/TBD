...
public interface Expression {
   ...
   /**
    * Returns true if the expression is an aggregation function.
    * @return true if the expression is an aggregation function
    */
   ...
   /**
    * Returns the aggregation function corresponding to an expression.
    * Throws an exception if the expression does not denote an
    * aggregation function.
    * @return the expression as an aggregation function
    */
   //public AggFunctionExpression asAggFunction();
