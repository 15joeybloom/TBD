...
public class Planner {
    private AggQueryPlanner aqplanner;
   private QueryPlanner qplanner;
   private UpdatePlanner uplanner;
   
   public Planner(QueryPlanner qplanner, UpdatePlanner uplanner, AggQueryPlanner aqplanner) {
      this.aqplanner = aqplanner;
   ...
   public Plan createQueryPlan(String qry, Transaction tx) {
      ...
      if(data instanceof AggQueryData) {
        return aqplanner.createPlan((AggQueryData)data, tx);
      }
